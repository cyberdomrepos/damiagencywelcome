        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 sm:gap-10 md:gap-12 items-stretch">
          <div className="md:col-span-5 text-left flex flex-col">
            <h2
              ...
              className={`text-4xl sm:text-5xl md:text-7xl lg:text-9xl font-extrabold text-white leading-tight transition-all duration-1000 ${
                titleVisible
            ...
            <div
              ...
              className={`mt-4 sm:mt-6 pr-3 sm:pr-4 md:pr-8 border-r border-white/10 max-w-xl mr-auto h-full flex flex-col transition-all duration-1000 delay-200 ${
                contentVisible
                  ? "opacity-100 translate-y-0"
                  : "opacity-0 translate-y-8"
              }`}
          ...
          <div className="md:col-span-7 flex items-stretch justify-start md:justify-end">
            <div
              ...
              className={`w-full md:w-[720px] bg-linear-to-br from-orange-500/95 via-rose-600/90 to-fuchsia-600/80 rounded-2xl sm:rounded-3xl p-6 sm:p-10 md:p-16 lg:p-20 shadow-lg ring-1 ring-black/20 text-white h-full flex flex-col justify-between transition-all duration-1000 delay-300 ${
                cardVisible
